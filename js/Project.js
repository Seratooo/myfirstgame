...
camera5.position.z = 26; camera5.position.y = 6
...
var update = function(){
     ...
     if(camera5.rotation.y < -1.0){
      //camera5.rotation.y = 0
      
      //8camera5.position.x -=8
...
function box (width,height,depth,widthSegments,heightSegments,depthSegments, color){
...
function cylinder(radiosTop, radioBottom, height,radialSeg,heightSeg,Color){
...
function mainSpaceShip(){
  const Cylinder = cylinder(1.0,1.10,5.68,59,129,0xaaa000)
...
function inSpaceShipe(PrimaryColor,SecondColor){
  ...
  const Cylinder = cylinder(1.00,1.00,1.00,8,1,PrimaryColor)
  ...
  const TyneCylinder1 = cylinder(0.34,0.16,3.04,23,1,PrimaryColor)
  ...
  const TyneCylinder2 = cylinder(0.34,0.16,3.04,23,1,PrimaryColor)
...
function Bomb(){
  ...
  const  SphereFirtBangShot = sphere(1,64,32,6,6,6,6);
